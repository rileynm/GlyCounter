...
// 
// This file (Fragment.cs) is part of CSMSL.Transcriptomics.
// 
...
namespace CSMSL.Glycomics
{
    ...
    {
        public Fragment(FragmentTypes type, int number, double monoisotopicMass, GlycanPolymer parent)
        {
            Type = type;
            Number = number;
            Parent = parent;
        ...
        public GlycanPolymer Parent { get; private set; }
