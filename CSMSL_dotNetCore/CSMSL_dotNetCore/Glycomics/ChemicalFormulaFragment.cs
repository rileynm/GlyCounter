...
// 
// This file (ChemicalFormulaFragment.cs) is part of CSMSL.Glycomics.
// 
...
namespace CSMSL.Glycomics
{
    public class ChemicalFormulaFragment : Fragment, IChemicalFormula
    {
        ...
        public ChemicalFormulaFragment(FragmentTypes type, int number, string chemicalFormula, GlycanPolymer parent)
            : this(type, number, new ChemicalFormula(chemicalFormula), parent)
        {
        }

        public ChemicalFormulaFragment(FragmentTypes type, int number, ChemicalFormula formula, GlycanPolymer parent)
